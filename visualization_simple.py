...
class SolidObjectVisualizer:
    ...
    def visualize(self, steps=1000, forces=None, torques=None):
        ...
        # Create animation
        ani = animation.FuncAnimation(fig, self.update, frames=steps, interval=self.dt, blit=True, fargs=(ax, forces, torques))

        # Save the animation to a video file
        ani.save('simple_collision.mp4', writer='ffmpeg', fps=30)
